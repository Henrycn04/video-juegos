...
ControllerManager::ControllerManager() {
    std::cout << "[CONTROLLERMANAGER] Se ejecutra constructor" << std::endl;
}
ControllerManager::~ControllerManager(){
    std::cout << "[CONTROLLERMANAGER] Se ejecutra destructor" << std::endl;
...
void ControllerManager::AddMouseButton(const std::string& action, int buttonCode){
    mouseButtonName.emplace(action, buttonCode);
